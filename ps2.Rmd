...
```{r}
filtered_d = d %>% 
  filter(is.na(DoNotUse))  # your code here: exclude subjects that are marked as "DoNotUse" aka keeps subject not marked "DoNotUse"
```
...
performance_diff_summary_d = performance_diff_d %>%
  ...
  summarize(MeanImprovementScore = ImprovementScore) |>
  filter(is.na(MeanImprovementScore) == FALSE)
  ## Your code here
```
